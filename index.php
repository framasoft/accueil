...
<html lang="fr">
  <head>
    ...
    <link href="<?php echo $home_subdir; ?>css/bootstrap-responsive.css" rel="stylesheet">
...
define("FNAV_LOCAL_BOOTSTRAP_JS", false);
define("FNAV_LOCAL_BOOTSTRAP_CSS", false);
define("FNAV_LOCAL_BOOTSTRAP_RESPONSIVE_CSS",false);
...
?>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="span8 accueil">
			...
			<div id="this-carousel-id" class="carousel slide"><!-- class of slide for animation -->
			  <div class="carousel-inner">
				  ...
				  <img src="<?php echo $home_subdir; ?>img/superHeroPenguinsLarge.gif" alt="Les superhéros de Framasoft" />
				  <div class="carousel-caption">
					<p>Framasoft fait peau neuve. Les fans, en extase, sautent de joie.</p>
				  </div>
				</div>
				<div class="item"><!-- class of active since it's the first item -->
				  <img src="<?php echo $home_subdir; ?>img/CouvMonOrchideSlider2.jpg" alt="#MonOrchide" />
				  <div class="carousel-caption">
					<p>Le romancier Pouhiou (édité chez Framabook) vient de réussir brillamment sa <a href="http://fr.ulule.com/monorchide/" alt="Campagne Ulule de #MonOrchide">campagne Ulule</a>.</p>
				  </div>
				</div>
				<!-- 
				<div class="item">
        ...
        <div class="span4" id="blocFramatrucs">
            ...
            <div class="span2">
			  ...
			  <div class="span2">
				<ul class="FramaTrucs">
					...
					<li><a href="http://www.framalang.org/" class="rouge">&#8827;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="violet1">Frama</span>lang</a></li>
				...
				<div class="fade modal hide" id="Credits">
					...
					<div class="modal hide fade" id="Mentions">
						...
						&nbsp;00045 </p>
							...
							<p>Ce site utilise Google Analytics, un service d’analyse de site
							...
							stockées par Google sur des serveurs situés aux &Eacute;tats-Unis. Google
							utilisera cette information dans le but d’évaluer votre utilisation du
							site, de compiler des rapports sur l’activité du site à destination de
							son éditeur et de fournir d’autres services relatifs à l’activité du
							site et à l’utilisation d’Internet. Google est susceptible de
							communiquer ces données à des tiers en cas d’obligation légale ou
							lorsque ces tiers traitent ces données pour le compte de Google, y
							compris notamment l’éditeur de ce site. Google ne recoupera pas votre
							...
							site. En utilisant ce site internet, vous consentez expressément au
							traitement de vos données nominatives par Google dans les conditions et
							pour les finalités décrites ci-dessus.</p>
      ...
      <footer  class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" id="topPgCommunaute"  >Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
	...
	<div class="container" >
      ...
      <div class="row header">
		...
		<div class="row" id="contentCommunaute">
			...
			<div class="span4 blocCommunaute" >
		...
		<div class="row">
			...
			<div class="span4 blocCommunaute">
				...
				<p class="miniBlocSubTitle">Libre ne veut pas dire gratuit&nbsp;!</p>
				<p class="miniBlocTexte">Framasoft ne serait rien sans sa communauté de bénévoles mais ne pourrait pas fonctionner non plus sans le service de l’association qui a des frais et emploie deux indispensables permanents. Notre financement dépend de vous, c’est-à-dire des dons individuels collectés sur Internet. <a href="http://soutenir.framasoft.org/">Si vous pensez que nous le méritons…</a></p>
				<p class="miniBlocLast">&nbsp;</p>
			</div>
      ...
      <footer  class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" id="topPgLogiciels" >Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
      ...
      <div class="row header">
		...
		<div class="row">
			...
			<div class="span8" id="presentationLogiciels">
		...
		<div class="row">
			...
			<div class="span3 miniBloc">
				...
				<p class="miniBlocTexte">Dans une clé USB (ou tout autre support mobile) utiliser en mode nomade une centaine de logiciels libres portables pour Windows, tester voire installer une distribution GNU/Linux ou encore avoir à accès hors ligne à toute la Wikipédia francophone.</p>
				<p class="EnVenteLibre"><a href="http://www.enventelibre.org/" class="bleu">[€]</a></p>
			</div>
      ...
      <footer class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" id="topPgCulture" >Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
	...
	<!-- Culture Libre -->
      ...
      <div class="row header">
		...
		<div class="row">
			...
			<div class="span6" id="presentationLibre">
				<div class="row">
			...
			<div class="span6">
				<div class="row">
					...
					<div class="span3 miniBloc2">
						...
						<p class="EnVenteLibre"><a href="http://www.enventelibre.org/" class="rouge">[€]</a></p>
					</div>
				...
				<div class="row">
					<div class="span3 miniBloc2">
						<h4 class="titreBloc goTo2"><a href="http://www.framalang.org/" alt="vers le wiki de Framalang" class="rouge FramaTrucsLien"><span class="violet1">Frama</span>lang</a></h4>
      ...
      <footer class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" id="topPgCloud"  >Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
	...
	<!-- Cloud libre -->
      ...
      <div class="row header">
		...
		<div class="row">
			...
			<div class="span6" id="presentationServices">
      ...
      <footer  class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" id="topPgVrac">Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
	...
	<!-- Vrac Libre -->
      ...
      <div class="row header">
		...
		<div class="row">
			...
			<div class="span8" id="presentationLibrenVrac">
      ...
      <footer id="" class="footer">
        <p><a class="btn" data-toggle="modal" href="#Credits" >Contact &amp; Crédits</a> <a class="btn" data-toggle="modal" href="#Mentions" >Mentions légales</a></p>
      </footer>
    ...
    <script type="text/javascript">
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-896440-1']);
