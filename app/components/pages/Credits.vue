    ...
    <main>
      ...
      >
        <section v-show="$t('hash') === 'blog'">
          ...
          <p>
            Le <span v-html="$t('html.blog')"></span> est propulsé par
        ...
        <section v-show="$t('hash') === 'date'">
          ...
          <p>
            L’application <span v-html="$t('html.date')"></span> est une instance du logiciel
            <b><a href="http://studs.u-strasbg.fr">STUdS !</a></b>
            développé à l’Université de Strasbourg depuis 2008.
          </p>
          <p>
            Pour les besoins de <span v-html="$t('html.date')"></span>, STUdS a
            fait l’objet d’un fork par l’équipe <span v-html="$t('html.soft')"></span>.
          ...
          <p>
            ...
            vous trouverez
            <a :href="`${$t('link.cloud')}/${$t('cloud.date')}`">
              un tutoriel détaillé sur <span v-html="$t('color.cloud')"></span>
            </a>.
          </p>
          ...
          <p>
            {{ $t('people.simonl') }}, {{ $t('people.pyg') }}, {{ $t('people.jo') }},
            Olivier Perez, Antonin, {{ $t('people.tcit') }} et la communauté
            <span v-html="$t('html.soft')"></span>.
          </p>

          <h2>Licence</h2>
          <p>
            <span v-html="$t('html.date')"></span> est placé, comme
            <b><a href="http://studs.u-strasbg.fr">STUdS !</a></b>,
        ...
        <section v-show="$t('hash') === 'degooglisons-internet'">
          ...
          <p>
            Maquette, intégration et développement&nbsp;: {{ $t('people.pyg') }},
            Christophe Masutti, Flaburgan, {{ $t('people.jo') }}
          </p>
          <p>Carte et illustrations&nbsp;: {{ $t('people.gee') }}</p>
          <p>Le site utilise le framework libre VueJS.</p>

          <h2>Licence</h2>
          <p>
            Sauf mention contraire, cette page et tous les contenus qui y figurent
            sont placés sous licence libre <span v-html="$t('license.ccbysa2fr')"></span>.
          </p>
          <p>Sources&nbsp;:</p>
          <ul>
            <li>
        ...
        <section v-show="$t('hash') === 'key'">
          ...
          <p>
            La <span v-html="$t('html.key')"></span> et son équipe doivent beaucoup
            au projet TheOpenCD sans lequel la <span v-html="$t('html.key')"></span>
            n’aurait probablement pas vu le jour.
          </p>
          <p>
            L’idée de la <span v-html="$t('html.key')"></span> doit énormément au
            travail de John T.Haller, sur les versions portables de certains logiciels
            initalement développés pour <a href="https://portableapps.com/">PortableApps.com</a>.
          </p>
          <p>
            Le contenu (texte) de l’interface de la <span v-html="$t('html.key')"></span>
            est publié sous licence <span v-html="$t('license.ccbysa2fr')"></span>.
          </p>
          <p>
            Les logiciels incluses dans la <span v-html="$t('html.key')"></span>
        ...
        <section v-show="$t('hash') === 'mindmap'">
          ...
          <p>
            <span v-html="$t('html.mindmap')"></span> repose sur le logciel libre
            <a href="http://www.wisemapping.com">Wisemapping</a>.
          </p>
        ...
        <section v-show="$t('hash') === 'pack'">
          ...
          <p>
            <span v-html="$t('html.pack')"></span> est un logiciel libre réalisé
            par {{ $t('people.simonl') }} composé&nbsp;:
          </p>
          <ul>
            <li>
              d’un site Internet sous licence libre
              <span v-html="$t('license.agpl3')"></span>.
            </li>
            <li>
              d’un installateur sous licence libre
              <span v-html="$t('license.gpl2')"></span>.
            </li>
          </ul>
          <p>
            Les sources de <span v-html="$t('html.pack')"></span> sont disponibles
            selon les termes de leur licence respective sur
            <a :href="$t('git.pack')">notre dépôt git</a>.
          </p>
        </section>
        ...
        <section v-show="$t('hash') === 'soutenir'">
          ...
          <p>
            Le site est propulsé par le logiciel libre
            <a href="https://www.drupal.org/">Drupal</a>.
          </p>
          ...
          <ul>
            <li>
              Stand Framasoft au RMLL2014,
              {{ $t('people.lam') }},
              <span v-html="$t('license.ccbysa4')"></span>
            </li>
            <li>
              <a href="https://flic.kr/p/i6ysF1"><em>Gigabit Switches</em></a>,
              Michael Himbeault,
              <span v-html="$t('license.ccby4')"></span>
            </li>
            <li>
              <a href="https://framablog.org/2013/11/21/framasoft-campagne-soutien-2013">
                <em>Framasoft - Campagne 2013</em>
              </a>,
              {{ $t('people.lldemars') }},
              licence  <span v-html="$t('license.lal')"></span>
            </li>
            <li>
              <a href="https://twitter.com/framasoft/status/421956457861353473">
                AG à Locaux Motiv'
              </a>,
              {{ $t('people.aka') }},
              <span v-html="$t('license.ccbysa4')"></span>
            ...
            <li>
              <a href="https://flic.kr/p/k1Wjhe"><em>Merci / Thank you</em></a>,
        ...
        <section v-show="$t('hash') === 'vectoriel'">
          ...
          <p>
            <span v-html="$t('html.vectoriel')"></span> est une application permettant
            de réalisser des dessins au format vectoriel (SVG).<br />
            Il s’agit de la version française, traduite par l’association
            <span v-html="$t('html.soft')"></span>,
            de l’application <a :href="$t('src.vectoriel')">"svg-edit"</a>
          </p>
          <p>
            <span v-html="$t('html.vectoriel')"></span> est placé sous licence
            libre <span v-html="$t('license.ccbysa3')"></span>
          </p>
        </section>
        ...
        <section v-show="$t('hash') === 'zic'">
          ...
          <p>
            <span v-html="$t('html.zic')"></span>, ou Framaz♪c, est une initiative
          ...
          <h2>Contexte</h2>
          <p>
            <span v-html="$t('html.zic')"></span> a été réalisé dans un contexte plutôt
            morose pour la musique non-libre&nbsp;:
            ...
            Ce projet apparaît aussi chez <span v-html="$t('html.soft')"></span>,
            association à but non-lucrative,
            dans le cadre d’un but de long terme d’élargir les perceptives.
            <span v-html="$t('html.soft')"></span> qui a commencé par la promotion du
          ...
          <h2>Réalisation</h2>
          <p>
            <span v-html="$t('html.zic')"></span> est un projet de la galaxie
            <span v-html="$t('html.soft')"></span>, ayant pour but la promotion de
            la musique libre&nbsp;:
            ...
            <span v-html="$t('html.zic')"></span> n’est donc pas une plateforme hébergeant de
          ...
          <p>
            ...
            {{ $t('people.pyg') }} pour sa disponibilité et pour le travail technique
            et ses conseils avisés,
            {{ $t('people.ben') }} pour son écoute et ses réponses pertinentes
            aux questions posées,
            {{ $t('people.jo') }} pour son aide fort précieuse à l’intégration des
            vidéos sur le site,
          ...
          <p>
            ...
            {{ $t('people.martin') }} et <span v-html="$t('html.soft')"></span>.
          ...
          <p>
            Le
            <a href="https://openclipart.org/detail/171161/acoustic-guitar-silhouette-by-j_alves-171161">
              logo de guitare
            </a>
          ...
          <p>
            Le <a href="https://openclipart.org/detail/150715/megaphone-by-worker">
              logo du mégaphone
            </a>
          ...
          <p>
            ...
            <a href="http://wordpress.org/extend/plugins/html5-jquery-audio-player/">
              HTML5 jQuery Audio Player
            </a>.
            Les graphiques dynamiques sont générés à l’aide de
            <a href="http://www.highcharts.com/">Highcharts</a>
            (sous licence
            <a href="shop.highsoft.com/highcharts.html">
